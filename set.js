...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~0yDlqfr40ZZUUKoGBiXP", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "46726405664", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
BAD_WORDS: process.env.BAD_WORDS || "whatsapp, pussy, anus, idiot", // Add Yours Separated by Comma(will be deleted if ANTIBAD is set to true)
